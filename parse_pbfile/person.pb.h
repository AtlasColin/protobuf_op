...
#if LANG_CXX11
inline void Person::set_face_id(::std::string&& value) {
...
#endif
inline void Person::set_face_id(const char* value) {
  GOOGLE_DCHECK(value != NULL);
...
inline void Person::set_face_id(const char* value, size_t size) {
...
inline ::std::string* Person::mutable_face_id() {
...
inline ::std::string* Person::release_face_id() {
...
inline void Person::set_allocated_face_id(::std::string* face_id) {
  if (face_id != NULL) {
